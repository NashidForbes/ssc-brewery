...
import guru.sfg.brewery.security.perms.custom.annotations.customer.CustomerCreatePermission;
import guru.sfg.brewery.security.perms.custom.annotations.customer.CustomerReadPermission;
import guru.sfg.brewery.security.perms.custom.annotations.customer.CustomerUpdatePermission;
...
public class CustomerController {
    ...
    @CustomerReadPermission
    @GetMapping
    public String processFindFormReturnMany(Customer customer, BindingResult result,
                                            Model model) {
        // find customers by name
        //ToDO: Add Service
        List<Customer> customers = customerRepository
                .findAllByCustomerNameLike("%" + customer.getCustomerName() + "%");
