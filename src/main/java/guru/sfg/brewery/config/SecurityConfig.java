...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // Our custom Security config for RestHeaderAuthFilter.class in security
    public RestHeaderAuthFilter restHeaderAuthFilter(
        ...
        // set authentication manager for user look at lines 35 and 57
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // Add our custom security filter in the security chain
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication().withUser("scott").password(
                "{bcrypt15}$2a$15$baOmQtw8UqWZRDQhMFPFj.xhkkWveCTQHe4OBdr8yw8QshejiSbI6")
                .roles("CUSTOMER");
    }
    //    @Override
    //    @Bean
